  ...
  return (
    <div className={`${className} relative`} >
      <div className="flex items-center gap-x-2.5 " onClick={_handleOpen}>
        ...
        <div className="flex flex-nowrap items-center gap-x-1.5 text-white cursor-pointer">
          <span className=" max-w-[10ch] overflow-hidden whitespace-nowrap text-ellipsis cursor-pointer">
            {data?.username}
          </span>
          <ArrowDown />
        </div>
