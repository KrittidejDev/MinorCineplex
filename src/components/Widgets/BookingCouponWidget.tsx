...
const BookingCouponWidget = () => {
    ...
    const checkCouponExpiry = (couponTitle: string) => {
        ...
        const selectedCouponData = coupons.find(coupon => coupon.title === couponTitle)
        ...
        <div className="w-full">
                        ...
                        <div className="space-y-4">
                            <div className="flex space-x-6">
                                <button
                                    ...
                                    className={`pb-2 font-medium transition-colors ${selectedPaymentMethod === 'credit'
                                ...
                                <button
                                    ...
                                    className={`pb-2 font-medium transition-colors ${selectedPaymentMethod === 'qr'
                                        ? 'text-white border-b-2 border-white'
                                        : 'text-gray-400 hover:text-white'
                                        }`}
                                >
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    <div className="flex flex-col">
                                        ...
                                        />
                                        {errors.cardNumber && (
                                            <span className="text-red-r64b text-sm mt-0.5">{errors.cardNumber}</span>
                                        )}
                                    </div>
                                    <div className="flex flex-col">
                                        ...
                                        />
                                        {errors.cardOwner && (
                                            <span className="text-red-r64b text-sm mt-0.5">{errors.cardOwner}</span>
                                        )}
                                    </div>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                                    <div className="flex flex-col flex-1 relative">
                                        ...
                                        {errors.expiryDate && (
                                            <span className="text-red-r64b text-sm mt-0.5">{errors.expiryDate}</span>
                                        )}
                                    </div>
                                    <div className="flex flex-col">
                                        ...
                                        />
                                        {errors.cvc && (
                                            <span className="text-red-r64b text-sm mt-0.5">{errors.cvc}</span>
                                        )}
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-gray-gc1b rounded-lg p-6 space-y-6 relative">
                        ...
                        <div className="space-y-3 pt-4 border-t border-gray-gf7e">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="text-white text-sm">
                                    {selectedPaymentMethod === 'credit' ? 'Credit card' : 'QR Code'}
                                </span>
                            </div>
                            <div className="flex justify-between">
                        ...
                        <Button
                            ...
                            className={`w-full py-3 rounded-lg font-semibold ${isCreditCardFormValid()
            ...
            {showCouponModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    {/* Backdrop */}
                    <div className="absolute inset-0 bg-gray-gc1b opacity-60" onClick={() => setShowCouponModal(false)}></div>

                    <div className="relative bg-gray-g63f rounded-lg p-6 w-full max-w-2xl mx-4">
                        {/* Modal Header */}
                        <div className="flex items-center justify-between mb-6">
                            <h2 className="text-white text-xl font-semibold">Select coupon</h2>
                            <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            {coupons.map((coupon, index) => (
                                <div
                                    key={index}
                                    className={`rounded-lg cursor-pointer hover:opacity-90 transition-opacity ${selectedCoupon === coupon.title ? 'ring-2 ring-white' : ''
                                        }`}
                                ...
                                >
                                    <div className="flex h-32 rounded-lg overflow-hidden bg-gray-gc1b">
                                        ...
                                        <div className="w-48 bg-gray-gc1b p-4 flex flex-col justify-between">
                                            <div>
                                                <div className="text-white text-sm font-bold mb-2">{coupon.title}</div>
                                                <div className="text-gray-300 text-xs">Valid until {coupon.validUntil}</div>
                                            </div>
                                            <div className="flex items-center space-x-1 mt-4">
                                                ...
                                                <ExpandRightLight width="12" height="12" color="#FFFFFF" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
