            ...
            <div className="flex-1 min-w-0">
                <div className="flex flex-col gap-4 sm:gap-6 lg:gap-8">
                    {showtimes.groups.map((group) => (
                        <div key={group.hallId} className="flex flex-col gap-2 sm:gap-3 lg:gap-4">
                            <div className="text-white/90 font-semibold text-base sm:text-lg lg:text-xl">{group.hallLabel}</div>
                            <ShowtimeSelection
                                times={group.times}
                                onChange={(time: any) => handleTimeSelect(time, { hallId: group.hallId })}
