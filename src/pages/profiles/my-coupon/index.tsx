...
const ProfileMyCoupons = () => {
  ...
  return (
    <div className="w-full bg-blue-b flex flex-col">
      <NavBarWidget />
      <div
        className="w-full flex flex-col md:flex-row items-start gap-4 sm:gap-6 md:gap-12 top-21 transition-all duration-500 ease-in-out 
    py-10 pl-4 lg:pl-20 md:py-15 xl:pl-56"
      >
        {/* ProfileBar */}
